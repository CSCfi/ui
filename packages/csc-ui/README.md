...
```ts
import type { CAlertType, CSelectItem } from '@cscfi/csc-ui';
```
...
{
  "html.customData": [
    "./node_modules/@cscfi/csc-ui/dist/vscode.html-custom-data.json"
  ],
  "css.customData": [
    "./node_modules/@cscfi/csc-ui/dist/vscode.css-custom-data.json"
  ]
}
```
