...
Validation is fail-loud: an unknown family name or an unparseable colour throws, so a typo cannot silently ship the default brand. Try it live below — the playground re-seeds this whole site.`,
    ...
    blocks: {
      vue: [{ lang: 'ts', code: themingCode('@cscfi/csc-ui-next') }],
      react: [{ lang: 'ts', code: themingCode('@cscfi/csc-ui-next-react') }],
      angular: [{ lang: 'ts', code: themingCode('@cscfi/csc-ui-next') }],
      typescript: [{ lang: 'ts', code: themingCode('@cscfi/csc-ui-next') }],
    },
  },
  {
    id: 'ssr-fouc',
      ...
      vue: [
        {
          filename: 'app.vue',
          lang: 'ts',
          code: `import { themeToCss } from '@cscfi/csc-ui-next';
      ...
      react: [
        {
          ...
          lang: 'tsx',
          code: `import { themeToCss } from '@cscfi/csc-ui-next-react';
...
import { themeToCss } from '@cscfi/csc-ui-next';
      ...
      typescript: [
        {
          filename: 'main.ts',
          lang: 'ts',
          code: `import { applyTheme, defineCustomElements } from '@cscfi/csc-ui-next';
...
c-button::part(root):hover {
  ...
  },
  {
    ...
    intro: {
      all: `If your app uses Tailwind v4, the library ships its semantic roles as a Tailwind theme export: @cscfi/csc-ui-next/css/tailwind-theme.css. It is a Tailwind v4 @theme mapping, not a standalone stylesheet — it maps utility names onto the --c-* custom properties, so it must be paired with tokens.css (which you are already loading for the components).
...
@import '@cscfi/csc-ui-next/css/tailwind-theme.css';`,
      },
      {
        lang: 'html',
 ...
 * Source of truth: csc-ui-next src/styles/css/tokens.css — the light/dark
