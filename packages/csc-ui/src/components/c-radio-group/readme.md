...
| `jokke`       | `jokke`        |                                                              | `boolean`                             | `false`            |
| `label`       | `label`        | Label of the radio group                                     | `string`                              | `undefined`        |
| `required`    | `required`     | Set as required                                              | `boolean`                             | `false`            |
| `returnValue` | `return-value` | Return only the item value rather than the whole item object | `boolean`                             | `false`            |
...
| -------------- | ------------------------------- | -------------------------------------------------------------- |
| `change-value` | Emit value change to the parent | `CustomEvent<{ value: string \| number \| CRadioGroupItem; }>` |
