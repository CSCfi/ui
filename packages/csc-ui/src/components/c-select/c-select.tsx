...
export class CSelect {
  private _selectId = `c-select-${selectIds++}`;
   ...
   * selectable items
   */
  @Prop({ reflect: true }) items: CSelectItem[] = [];
  ...
  private _valueChangedHandler(item: CSelectItem) {
    ...
    console.log('haistakaa makkaraa', this.returnValue, { value });
