...
| `footerOptions`       | --                     | Items per page options                                    | `{ hideDetails?: boolean; simple?: boolean; hideRange?: boolean; size?: "default" \| "small"; }`                                                                                                                  | `{     hideDetails: false,     simple: false,     hideRange: false,     size: 'default',   }` |
